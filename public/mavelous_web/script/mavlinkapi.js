...
goog.require('Mavelous.NarekVehicle');
goog.require('Mavelous.NarekVehicle');
...
Mavelous.MavlinkAPI.prototype.initialize = function() {
  ...
  this.messageModels = {};
  /** @type {?Mavelous.NarekVehicle} */
  this.NarekVehicle = null;
};
...
Mavelous.MavlinkAPI.prototype.offlineUpdate = function() {
  goog.asserts.assert(this.NarekVehicle);
  this.NarekVehicle.update();
  var msgs = this.NarekVehicle.requestMessages(this.messageModels);
...
Mavelous.MavlinkAPI.prototype.useOfflineMode = function() {
  if (this.online && !this.gotonline) {
    ...
    this.online = false;
    this.NarekVehicle = new Mavelous.NarekVehicle();
  }
};
